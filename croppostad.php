...
<div class="row" style="height: auto;">
  ...
  <div class="col-sm" align="center"><a class="navbar-brand" href="croppostcomplain.php">Payment Status</a></div>
...
<br>
<form action="cropupload.php" method="post" enctype="multipart/form-data">
            <div class="preview text-center">
                <img class="preview-img" src="images/cropicon.jpg" alt="Preview Image" width="150" height="150"/>
            ...
            <div class="form-group">
              <input class="form-control" type="text" name="quant" required placeholder="Enter Quantity"/>
                <span class="Error"></span>
            </div>
            <div class="form-group">
