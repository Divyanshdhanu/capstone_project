...
$q="select * from fertdealer where email_id='$u_name' && password='$pass'";
...
<div class="row" style="height: auto;">
  ...
  <!-- Navbar content -->
  <div class="col-sm" align="center"><a class="navbar-brand" href="fertpostad.php" onclick="showform();">Post Advertise</a></div>
  <div class="col-sm" align="center"><a class="navbar-brand" href="fertstatus.php">Payment Status</a></div>
  <div class="col-sm" align="center"><a class="navbar-brand" href="fertpostcomplain.php">Complain Section</a></div>
...
<br>
<form action="fertupload.php" method="post" enctype="multipart/form-data">
